...
const ARBITRUM_DERIVATION_PATH = "m/44'/60'/0'/0/0";
...
function deriveWalletFromMnemonic(mnemonic) {
    ...
    const wallet = HDNodeWallet.fromPhrase(normalizedMnemonic, "", ARBITRUM_DERIVATION_PATH);
...
function normalizePrivateKey(secret) {
    ...
    throw AppError.validation("Invalid Arbitrum wallet secret");
}
