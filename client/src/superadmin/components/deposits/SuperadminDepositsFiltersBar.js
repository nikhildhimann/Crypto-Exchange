...
const SORT_OPTIONS = Object.freeze([
  ...
  { value: "confirmations:desc", label: "Most confirmations" },
  { value: "confirmations:asc", label: "Fewest confirmations" },
  { value: "status:asc", label: "Status A-Z" },
]);

export function SuperadminDepositsFiltersBar({
  query,
  searchDraft,
  setSearchDraft,
  userIdDraft,
  ...
  return (
    <div className="superadmin-filter-card rounded-[28px] border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.05),rgba(255,255,255,0.03))] p-4 shadow-[0_18px_60px_rgba(2,6,23,0.24)] backdrop-blur-xl sm:p-5">
      <div className="flex flex-col gap-4">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          <div className="space-y-1.5">
            ...
            <p className="text-sm leading-6 text-slate-400">
              Server-driven deposit search and filters for scalable monitoring across users, accounts, wallets, and confirmation states.
            </p>
          </div>
        ...
        <div className="grid gap-3 xl:grid-cols-[minmax(0,1.25fr)_minmax(0,1fr)_minmax(0,1fr)_minmax(0,1fr)_repeat(4,minmax(0,0.8fr))]">
        ...
        <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-5">
          ...
          <div className="rounded-[22px] border border-dashed border-white/10 bg-white/[0.02] px-4 py-3">
            ...
            <p className="mt-2 text-sm leading-5 text-slate-400">
              Network filters are still not exposed on this page, but chain, status, user, and wallet filters map directly to the backend contract.
            </p>
          </div>
        </div>
      </div>
