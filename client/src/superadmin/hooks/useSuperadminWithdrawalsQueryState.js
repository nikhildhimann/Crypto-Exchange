...
export function useSuperadminWithdrawalsQueryState() {
  ...
  return {
    ...
    openWithdrawal: (withdrawalId) => updateParams({ selected: withdrawalId }, { replace: true }),
    closeWithdrawal: () => updateParams({ selected: "" }, { replace: true }),
    clearFilters: () =>
      updateParams(
        {
          search: "",
